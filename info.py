...
# Bot Session Name
SESSION = environ.get('SESSION', 'RSautoBot')

# Your Telegram Account Api Id And Api Hash
API_ID = int(environ.get('API_ID', '20684231'))
API_HASH = environ.get('API_HASH', '47bc7c094d0530ff2faa3bb0b624bfe2')

# Bot Token, This Is Main Bot
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Admin Telegram Account Id For Withdraw Notification Or Anything Else
ADMIN = int(environ.get('ADMIN', '1711837878'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002524430230'))
...
LINK_URL = environ.get("LINK_URL", "https://bingelaunch.blogspot.com/p/g.html")
